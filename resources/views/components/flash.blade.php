...
<div class="p-4 rounded-md bg-yellow-50">
    <div class="flex">
        ...
        <div class="ml-3">
            <p class="text-sm font-medium text-yellow-800">{{ Session::get('warning') }}</p>
        </div>
    </div>
</div>
@elseif (Session::has('info') or Session::has('message'))
<div class="p-4 rounded-md bg-blue-50">
    <div class="flex">
        ...
        <div class="ml-3">
            <p class="text-sm font-medium text-blue-800">{{ Session::get('info') }} {{ Session::get('message') }}</p>
        </div>
    </div>
</div>
@endif
