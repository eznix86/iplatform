<x-app-layout>
    ...
    <div class="container py-12">
        <div class="space-y-10 divide-y divide-gray-900/10">
            ...
            <div class="grid grid-cols-1 pt-10 gap-x-8 gap-y-8 md:grid-cols-3">
                <div class="px-4 sm:px-0">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Drivers</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Add/Remove Drivers</p>
                </div>
            ...
            <div class="grid grid-cols-1 pt-10 gap-x-8 gap-y-8 md:grid-cols-3">
                <div class="px-4 sm:px-0">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Vehicles</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Add/Remove Vehicles</p>
                </div>
